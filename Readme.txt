This is a .NET 3.5 wrapper library for MPlayer.  It has been tested on Windows XP/7 and Ubuntu Linux 10.10 and OpenSuse Linux 10.3.  It should also work on OS X although it has not been tested.  Written in C#.
