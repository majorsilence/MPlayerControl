namespace Majorsilence.Media.TestApp
{
    partial class Form1
    {
        ...
        {
            this.winFormMPlayerControl1 = new Majorsilence.Media.PlayerControls.WinFormMPlayerControl();
            this.SuspendLayout();
            // 
        ...
        private Majorsilence.Media.PlayerControls.WinFormMPlayerControl winFormMPlayerControl1;
    }
}
