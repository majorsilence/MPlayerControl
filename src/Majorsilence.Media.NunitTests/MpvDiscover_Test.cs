...
public class MpvDiscover_Test
{
    ...
    {
        using (var a = new MpvDiscover(GlobalVariables.Video1Path, GlobalVariables.LibMpvPath))
        {
            a.Execute();
    ...
    {
        using (var a = new MpvDiscover(GlobalVariables.Video2Path, GlobalVariables.LibMpvPath))
        {
            a.Execute();
            Assert.AreEqual(8, a.AudioBitrate);
        }
