...
namespace MplayerUnitTests
{
    ...
    public class MPlayerDiscover_Test
    {
        ...
        {
            using (var a = new Majorsilence.Media.Videos.MPlayerDiscover(GlobalVariables.Video1Path, GlobalVariables.MplayerPath))
            {
                a.Execute();
        ...
        {
            using (var a = new Majorsilence.Media.Videos.MPlayerDiscover(GlobalVariables.Video2Path, GlobalVariables.MplayerPath))
            {
                a.Execute();
                Assert.AreEqual(128, a.AudioBitrate);
            }
