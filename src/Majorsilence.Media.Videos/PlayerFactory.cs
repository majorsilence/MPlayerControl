...
namespace Majorsilence.Media.Videos
{
    public static class PlayerFactory
    {
        ...
        private static Majorsilence.Media.Videos.Player Windows (long handle, string path)
        {
        ...
        private static Majorsilence.Media.Videos.Player Linux (long handle, string path)
        {
            if (path.Contains ("mplayer")) {
        ...
        private static Majorsilence.Media.Videos.Player Mac (long handle, string path)
        {
            if (path.Contains ("mplayer")) {
