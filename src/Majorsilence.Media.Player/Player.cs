...
namespace Majorsilence.Media.Player
{
    ...
    public partial class Player : Form
    {
        ...
        private Majorsilence.Media.PlayerControls.VideoView _videoView;
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            if (System.IO.File.Exists(Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath) == false
                && System.IO.File.Exists(b.MPlayer) == false)
            {
                ...
                if (discovered != null)
                {
                    Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath = discovered;
                    Majorsilence.Media.Player.Properties.Settings.Default.Save();
                }
                else
                {
            ...
            this._videoView = new Majorsilence.Media.PlayerControls.VideoView { Dock = DockStyle.Fill };
            panelVideo.Controls.Add(this._videoView);

            this._play = Majorsilence.Media.Videos.PlayerFactory.Get(panelVideo.Handle.ToInt64(), Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath);
            //this._play = new MPlayer(panelVideo.Handle.ToInt64(), backend, Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath);
            if (this._play == null)
            {
        ...
        {
            btnPlay.Image = Majorsilence.Media.Player.Properties.Resources.play;
            this._play.Stop();
            this.ResetTime();
        ...
        private async void btnPlay_Click(object sender, EventArgs e)
        {
            ...
            if (this._play.CurrentStatus != MediaStatus.Stopped)
            {
                if (this._play.CurrentStatus == MediaStatus.Paused)
                {
                    ...
                    btnPlay.Image = Majorsilence.Media.Player.Properties.Resources.pause;
                }
            ...
            _videoSettings = Majorsilence.Media.Videos.DiscoverFactory.Get(this._filePath, Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath);
