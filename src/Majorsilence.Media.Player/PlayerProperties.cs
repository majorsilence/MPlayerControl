...
namespace Majorsilence.Media.Player
{
    public partial class PlayerProperties : Form
    {
        ...
        {
            textBox1.Text = Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath;
        }
        ...
        {
            Majorsilence.Media.Player.Properties.Settings.Default.MPlayerPath = textBox1.Text.Trim();
