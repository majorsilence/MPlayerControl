// Majorsilence.Media.PlayerControls — WinForms usage example.
//
...
namespace Majorsilence.Media.PlayerControls.Examples.WinForms;
...
internal sealed class MainForm : Form
{
    public MainForm()
    {
        Text = "Majorsilence.Media.PlayerControls on WinForms";
        Width = 900;
        Height = 600;
